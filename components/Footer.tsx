        ...
        <div className="bg-black py-8 w-full mt-[30px] transition-all">
            <div className="max-w-[1340px] mx-auto px-[10px] text-white flex-col ">
                <div className="flex gap-4 items-end justify-center sm:justify-between">
                    ...
                    <Link href='/' className="text-[32px] font-black mr-4 leading-none ">Urpaq</Link>
                ...
                <div className="flex justify-between flex-col items-center sm:items-start sm:flex-row">
                    ...
                    <div className="flex flex-col mt-8 items-center text-center sm:text-left sm:items-start">
                        <h4>БИН:</h4>
                        <div className="flex flex-col">
                            <h4 className="text-[18px] ">870922450441</h4>
                        </div>
                    </div>
                </div>
                <div
                    className="flex justify-between flex-col-reverse sm:flex-row gap-4 mt-8 text-center sm:text-left sm:items-start">
                    <div className="">
                        <p className="opacity-50 ">© Urpaq 2025</p>
                        <Link href='https://t.me/l0xa1ch' rel="nofollow" className="opacity-30 leading-none">made by KARACHKOV</Link>
                    </div>
                    <div className="flex sm:items-end flex-col">
                        ...
                        <p className="opacity-50">Кофе, круассаны, история...</p>
                    </div>
                </div>
