...
export default function Taplink() {
    return (
        <div
            ...
            <Image style={{ filter: 'brightness(0.3)' }} src='/herobg.webp' fill alt="Чаи"
                className="rounded-xl z-0 " style={{ objectFit: 'cover' }} />
                ...
                <div
                    ...
                    <div className="flex gap-2 sm:gap-4 h-full sm:h-max">
                        <Link href={'/menu'}
                            ...
                            <Image style={{ filter: 'brightness(0.65)' }} src='/coffe.webp' fill
                                alt="Чаи" className="rounded-xl" style={{ objectFit: 'cover' }} />

                            <p className="z-20">Кофе</p></Link>
                        <Link href={'/menu'}
                            className="shadow-xl shadow-white/20 transition-all hover:rotate-6 relative flex cursor-pointer flex-col p-2 rounded-xl text-white w-full h-[120px] sm:h-[100px] sm:w-[100px] lg:w-[120px] lg:h-[120px] justify-end font-black">
                            <Image style={{ filter: 'brightness(0.65)' }} src='/macaroon-mini.webp' fill
                                alt="Чаи" className="rounded-xl" style={{ objectFit: 'cover' }} />
                    ...
                    <div className="flex gap-2 sm:gap-4 h-full sm:h-max">
                        ...
                        <Link href={'/menu'}
                            className="shadow-xl shadow-white/20 transition-all hover:-rotate-6 relative flex cursor-pointer flex-col p-2 rounded-xl text-white w-full h-[120px] sm:h-[100px] sm:w-[100px]  lg:w-[120px] lg:h-[120px] justify-end font-black">
                            <Image style={{ filter: 'brightness(0.65)' }} src='/milkshake.webp' fill
                                alt="Чаи" className="rounded-xl" style={{ objectFit: 'cover' }} />
                    ...
                    <div className="flex gap-2 sm:gap-4 h-full sm:h-max">
                        ...
                        <Link href={'/menu'}
                            className="shadow-xl shadow-white/20 transition-all hover:rotate-6 relative flex cursor-pointer flex-col p-2 rounded-xl text-white w-full h-[120px] sm:h-[100px] sm:w-[100px]  lg:w-[120px] lg:h-[120px] justify-end font-black">
                            <Image style={{ filter: 'brightness(0.65)' }} src='/shipping.webp' fill
                                alt="Чаи" className="rounded-xl" style={{ objectFit: 'cover' }} />
